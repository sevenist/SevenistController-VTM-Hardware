...
![PCB render](images/relControll.png)
...
> **Status: updated, should work but not tested yet. will upload soon some BOM file.**
> Fabricate at your own risk until it's confirmed working.

![Assembly render](images/relControll2.png)
## Repository layout

```
relControll.kicad_pro / .kicad_sch / .kicad_pcb   KiCad 10 project, schematic, board
